...
| Last verified | 2026-09-14（keyed 401 实测 + keyless 成功实测） |
...
| Last verified | 2026-09-14（keyed extract 实测 200 + keyless search 实测 200） |
...
| 文档来源 | 包内 docstring（`inspect.getdoc`）+ 实测 |
